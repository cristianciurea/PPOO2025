...
public class Test {
	...
	{
		HumanBeing n1 = new HumanBeing();
		HumanBeing n2 = new HumanBeing("12345", "Ion","Popescu");
		HumanBeing n3 = (HumanBeing)n2.clone();
		n3.setId("33333");
		n3.setFirstName("Clona");
		
		HumanBeing nameArray[] = {
				new HumanBeing("00000", "Marin","Georgescu"),
				new HumanBeing("11111", "Vasile","Costescu"),
				new HumanBeing("22222", "Gigel","Predescu")
		};
		
		//------------- ArrayList
		ArrayList<HumanBeing> listaNume = new ArrayList<HumanBeing>();
		listaNume.add(n1);
		listaNume.add(n2);
		...
		//------------- List<>
		List<HumanBeing> names = Arrays.asList(nameArray);
		
		HumanBeing[] vectorNume = names.toArray(new HumanBeing[0]);
		...
		for(Iterator<HumanBeing> i = names.iterator(); i.hasNext();)
		{
			HumanBeing n = i.next();
		...
		//------------- Vector<>
		Vector<HumanBeing> nameVector = new Vector<>();
		nameVector.add(n1);
		nameVector.add(n2);
		nameVector.add(n3);
		nameVector.remove(n1);
		nameVector.add(0, n3);
		for(HumanBeing n: nameVector)
			System.out.println("vector: "+n.toString());

		//------------- SortedSet<>
		SortedSet<HumanBeing> sNames = new TreeSet<HumanBeing>();
		sNames.addAll(names);
		sNames.add(n3);
		...
		Hashtable<Integer, ArrayList<HumanBeing>> h2 = new
				Hashtable<Integer, ArrayList<HumanBeing>>();
		h2.put(2001, new ArrayList<HumanBeing>());
		h2.get(2001).add(nameArray[0]);
		h2.get(2001).add(nameArray[1]);
		
		h2.put(2320, new ArrayList<HumanBeing>());
